...
<title>Zalora Sraper - Price Notif</title>
<style type="text/css">
* {
...
<center class="wrapper" style="width:100%;table-layout:fixed;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;background-color:#f3f2f0;">
                                  ...
                                  <tbody>
                                    <tr>
                                      <td class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;" bgcolor="#FFFFFF"><!-- ======= start header ======= -->
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%"  bgcolor="#2c2c2c">
                                          <tr>
                                            <td class="two-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;text-align:center;font-size:0;" ><!--[if (gte mso 9)|(IE)]>
												<table width="100%" style="border-spacing:0" style="text-align:center;">
												  <tr>
													<td valign="top" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0px;" >
													<![endif]-->
                                              
                                                    <a href="#" target="_blank"><img src="{{ asset('vendor/now/assets/img/now-logo-rotate.png') }}" alt="" width="60" height="60" style="border-width:0; max-width:60px;height:auto; display:block;margin: auto 47%;" align="left"/></a>
                                                    <td>
                                                   </tr>
                                                </table>
                                            </td>
  ...
  <![endif]-->
                      ...
                      <div>
                        <p style="color:#262626; font-size:32px; text-align:center; font-family: Verdana, Geneva, sans-serif">Your Item Has Updated</p>
                        <!-- START BUTTON -->
  ...
  <![endif]--></td>
                    ...
                    <td class="two-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;text-align:center;font-size:0;"><!--[if (gte mso 9)|(IE)]>
                      ...
                      <div class="column" style="width:100%;max-width:399px;display:inline-block;vertical-align:top;">
                        <table class="contents" style="border-spacing:0; width:100%" bgcolor="#FFFFFF">
                          <tr>
                            <td width="39%" align="center" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><img src="{{ $item->image_link }}" width="309" alt="" style="border-width:0;width:40%; height:auto;" /></td>
                          </tr>
                        </table>
                      </div>
                      ...
                      <div class="column" style="width:100%;max-width:399px;display:inline-block;vertical-align:top;">
                        <table width="100%" style="border-spacing:0">
                          <tr>
                            <td class="inner" style="padding-top:0px;padding-bottom:10px; padding-right:20px;padding-left:30px;"><table class="contents" style="border-spacing:0; width:100%">
                                <tr>
                                  <td align="center" valign="middle" style="padding-top:20px; padding-right:30px">
                                    <p style="font-size:20px; text-decoration:none; color:#262626; font-family: Verdana, Geneva, sans-serif; text-align:left">
                                    ...
                                    <p style="font-size:14px; text-decoration:none; color:#3a3d41; font-family: Verdana, Geneva, sans-serif; text-align:left; line-height:22px">
                                        ...
                                        <strong>Price Discount</strong> <br />
                                        ...
                                        <p style="font-size:14px; text-decoration:none; color:#3a3d41; font-family: Verdana, Geneva, sans-serif; text-align:left; line-height:22px">{{ $item->created_at }}<p>
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background: #2c2c2c">
                  <tr>
                    <td height="30">&nbsp;</td>
                  </tr>
                  <tr>
                            ...
                            <td class="inner" style="padding-top:0px;padding-bottom:10px; padding-right:10px;padding-left:10px;"><table class="contents" style="border-spacing:0; width:100%">
                                <tr>
                                  <td width="32%" align="center" valign="top" style="padding-top:10px"><table width="150" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td width="33" align="center" style="color: #fff">
